const projects = [
  ...
  //   description:
  //     "A web application created in collaboration with the the Forsyth County Schools in Georgia. The application is used to increase the efficiency of data collection and documentation for their newly developed scholastic gaming course, which would help them analyze their data and possibly pitch it to the Georgia Board of Education in the future.",
  //   tags: ["React", "HTML/CSS", "JavaScript", "Express.js", "MySQL"],
  //   figma:
  //     "https://www.figma.com/file/dz5O1uThJeIpi0dDMtdxQA/Mockups-Fall-2023?type=design&node-id=0-1&mode=design&t=sJWEUDrKXBwedvdG-0",
  // },
  // {
  //   key: 5,
  ...
  //   startDate: "2022-09-01",
  //   description:
  //     "A comprehensive website serving as a centralized platform for on-campus events, catering to a diverse audience encompassing students, staff, alumni, and external guests.",
